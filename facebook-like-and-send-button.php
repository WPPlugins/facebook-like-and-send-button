<?php
/*
Plugin Name: Facebook Like and Send Button
Plugin URI: http://www.pasqualepuzio.it
Description: The simplest way to add Facebook Like and Send Buttons to your WordPress blog.  One click setup and start getting Facebook likes and sendings for posts on your blog.
Version: 1.1
...
function fblb_add_facebook_button( $content ) {
    ...
    /*$fb_html = '<iframe src="http://www.facebook.com/plugins/like.php?href=' . $permalink .'&amp;layout=standard&amp;send=true&amp;show_faces=true&amp;width=450&amp;action=like&amp;colorscheme=light&amp;height=80" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe>';*/
    
    $fb_html = '<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="'.$permalink.'" send="true" width="450" show_faces="true" font=""></fb:like>';
...
function fblb_option_settings_api_init() {
        add_settings_field( 'fblb_setting', 'Facebook Like and Send Button', 'fblb_setting_callback_function', 'reading', 'default' );
